...
export default function Stage3({nextStage=()=>{}}) {
    ...
    const correct = ()=>{
      ...
      return (
        <div className='flex flex-wrap justify-center'>
            <div className='font-bold font-mono text-lg'>豬嘟最多次過夜是在哪個縣市?</div>
            <div className='flex flex-wrap w-full justify-center'>       
                ...
                <button onClick={correct} className="bg-orange-500 w-1/3 text-white font-bold py-2 px-4 border-b-4 border-orange-700  rounded">
                    桃 園
                </button>
